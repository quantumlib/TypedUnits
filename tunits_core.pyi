...
@overload
def raw_WithUnit(
    value: Any, conv: conversion | dict[str, Any], base_units: UnitArray, display_units: UnitArray
) -> 'ValueArray' | 'Value' | 'Complex':
    """
...
class Value(WithUnit):
    ...
    def __divmod__(self, other: Any) -> tuple[_NUMERICAL_TYPE_OR_ARRAY, 'WithUnit']: ...
    @overload
    def __add__(self, other: _REAL_NUMERICAL_TYPE) -> Value: ...
    @overload
    ...
    @overload
    def __sub__(self, other: _REAL_NUMERICAL_TYPE) -> Value: ...
    @overload
    ...
    @overload
    def __truediv__(self, other: _REAL_NUMERICAL_TYPE) -> Value: ...
    @overload
    ...
    @overload
    def __mul__(self, other: _REAL_NUMERICAL_TYPE) -> Value: ...
    @overload
    ...
    @overload
    def __mod__(self, other: _REAL_NUMERICAL_TYPE) -> Value: ...
    @overload
    ...
    @overload
    def __floordiv__(self, other: _REAL_NUMERICAL_TYPE) -> Value: ...
    @overload
...
class ValueArray(WithUnit):
    ...
    def __copy__(self) -> 'ValueArray': ...
    def __deepcopy__(self) -> 'ValueArray': ...
    ...
    def __abs__(self) -> 'ValueArray': ...
    def __divmod__(self, other: Any) -> tuple[_NUMERICAL_TYPE_OR_ARRAY, 'WithUnit']: ...
    @overload
    def __add__(self, other: _REAL_NUMERICAL_TYPE) -> 'ValueArray': ...
    @overload
    def __add__(self, other: complex) -> 'ValueArray': ...
    @overload
    def __add__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> 'ValueArray': ...
    @overload
    def __add__(self, other: 'Complex') -> 'ValueArray': ...
    @overload
    def __add__(self, other: 'Value') -> 'ValueArray': ...
    @overload
    def __add__(self, other: 'ValueArray') -> 'ValueArray': ...
    @overload
    def __add__(self, other: 'WithUnit') -> Any: ...
    @overload
    def __radd__(self, other: complex) -> 'ValueArray': ...
    @overload
    def __radd__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> 'ValueArray': ...
    @overload
    def __sub__(self, other: _REAL_NUMERICAL_TYPE) -> 'ValueArray': ...
    @overload
    def __sub__(self, other: complex) -> 'ValueArray': ...
    @overload
    def __sub__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> 'ValueArray': ...
    @overload
    def __sub__(self, other: 'Complex') -> 'ValueArray': ...
    @overload
    def __sub__(self, other: 'Value') -> 'ValueArray': ...
    @overload
    def __sub__(self, other: 'ValueArray') -> 'ValueArray': ...
    @overload
    def __sub__(self, other: 'WithUnit') -> Any: ...
    @overload
    def __rsub__(self, other: complex) -> 'ValueArray': ...
    @overload
    def __rsub__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> 'ValueArray': ...
    @overload
    def __truediv__(self, other: _REAL_NUMERICAL_TYPE) -> 'ValueArray': ...
    @overload
    def __truediv__(self, other: complex) -> 'ValueArray': ...
    @overload
    def __truediv__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> 'ValueArray': ...
    @overload
    def __truediv__(self, other: 'Complex') -> 'ValueArray': ...
    @overload
    def __truediv__(self, other: 'Value') -> 'ValueArray': ...
    @overload
    def __truediv__(self, other: 'ValueArray') -> 'ValueArray': ...
    @overload
    def __truediv__(self, other: 'WithUnit') -> Any: ...
    @overload
    def __rtruediv__(self, other: complex) -> 'ValueArray': ...
    @overload
    def __rtruediv__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> 'ValueArray': ...
    @overload
    def __floordiv__(self, other: _REAL_NUMERICAL_TYPE) -> NDArray[Any]: ...
    @overload
    def __floordiv__(self, other: complex) -> NDArray[Any]: ...
    @overload
    def __floordiv__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> NDArray[Any]: ...
    @overload
    def __floordiv__(self, other: 'Complex') -> NDArray[Any]: ...
    @overload
    def __floordiv__(self, other: 'Value') -> NDArray[Any]: ...
    @overload
    def __floordiv__(self, other: 'ValueArray') -> NDArray[Any]: ...
    @overload
    def __floordiv__(self, other: 'WithUnit') -> NDArray[Any]: ...
    @overload
    def __rfloordiv__(self, other: complex) -> NDArray[Any]: ...
    @overload
    def __rfloordiv__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> NDArray[Any]: ...
    @overload
    def __mul__(self, other: _REAL_NUMERICAL_TYPE) -> ValueArray: ...
    @overload
    def __mul__(self, other: complex) -> ValueArray: ...
    @overload
    def __mul__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> ValueArray: ...
    @overload
    def __mul__(self, other: 'Complex') -> ValueArray: ...
    @overload
    def __mul__(self, other: 'Value') -> ValueArray: ...
    @overload
    def __mul__(self, other: 'ValueArray') -> ValueArray: ...
    @overload
    def __mul__(self, other: 'WithUnit') -> Any: ...
    @overload
    def __rmul__(self, other: complex) -> ValueArray: ...
    @overload
    def __rmul__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> ValueArray: ...
    @overload
    def __mod__(self, other: _REAL_NUMERICAL_TYPE) -> ValueArray: ...
    @overload
    def __mod__(self, other: complex) -> ValueArray: ...
    @overload
    def __mod__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> ValueArray: ...
    @overload
    def __mod__(self, other: 'Complex') -> ValueArray: ...
    @overload
    def __mod__(self, other: 'Value') -> ValueArray: ...
    @overload
    def __mod__(self, other: 'ValueArray') -> ValueArray: ...
    @overload
    def __mod__(self, other: 'WithUnit') -> ValueArray: ...
    @overload
    def __rmod__(self, other: complex) -> ValueArray: ...
    @overload
    def __rmod__(self, other: list[Any] | tuple[Any] | NDArray[Any]) -> ValueArray: ...
